import numpy as np
from graph_utils import incidence_matrix, remove_nodes, ssp_to_torch, serialize, deserialize, get_edge_count, diameter, radius
...
def node_label(subgraph, max_distance=1):
    ...
    #### 主要改动可以在这里 这里是获得所有 相交3-hop点到两个节点的路径  ########
...
def subgraph_extraction_labeling(ind, A_list, h=1, enclosing_sub_graph=False, max_nodes_per_hop=None, max_node_label_value=None):
...
## 求取enclosing subgraph ## (3 hop 以内)
if __name__ == '__main__':
    hop = 3

    task_dir = '../KG_Data/YAGO3-10'
