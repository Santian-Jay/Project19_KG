...
def nn_categorization(new_train):
	...
	temp = open('dataset/temp_text.txt', 'w')
	...
	triple = open("dataset/temp_text.txt", "r")
	...
	sn1=0
	snn=0
	f = open("dataset/temp_text.txt", "r")
	tot = (int)(f.readline())
	for i in range(tot):
		content = f.readline()
		h,t,r = content.strip().split()
	...
	# used code
	f = open("dataset/temp_text.txt", "r")
	f11 = open("dataset/1-1.txt", "w")
	f1n = open("dataset/1-n.txt", "w")
	fn1 = open("dataset/n-1.txt", "w")
	fnn = open("dataset/n-n.txt", "w")
	fall = open("dataset/test2id_all.txt", "w")
	tot = (int)(f.readline())
	fall.write("%d\n"%(tot))
	f11.write("%d\n"%(s11))
	f1n.write("%d\n"%(s1n))
