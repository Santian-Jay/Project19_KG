...
def draw_subgraph(frame, search_entity, search_relation, max_depth, max_entities, f_entity, f_relation, f_fact):
    # coding:utf-8
    ...
    # sub = breadFirstGraphExtract(G, search_entity, search_relation, max_entities, max_depth)
    # sub = breadFirstGraphExtract(G, search_entity, search_relation, 9, 2)
    ...
    frame2.pack()
    canvas = FigureCanvasTkAgg(plt, master=frame2)
    canvas.draw()
