...
from pythonProject_v5.ttkbootstrap.themes.standard import STANDARD_THEMES
from pythonProject_v5.ttkbootstrap.publisher import Publisher, Channel
from pythonProject_v5.ttkbootstrap import utility as util
from pythonProject_v5.ttkbootstrap import colorutils
from PIL import ImageColor


try:
    # prevent app from failing if user.py gets corrupted
    from pythonProject_v5.ttkbootstrap.themes.user import USER_THEMES
...
class Style(ttk.Style):
    ...
    def __init__(self, theme=DEFAULT_THEME):
        ...
        # apply localization
        from pythonProject_v5.ttkbootstrap import localization
...
class Bootstyle:
    ...
    def setup_ttkbootstap_api():
        ...
        from pythonProject_v5.ttkbootstrap.widgets import TTK_WIDGETS
        from pythonProject_v5.ttkbootstrap.widgets import TK_WIDGETS
